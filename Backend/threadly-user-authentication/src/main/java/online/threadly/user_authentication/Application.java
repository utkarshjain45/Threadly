package online.threadly.user_authentication;
...
public class Application {
	...
	private static void loadEnv() {
		...
		while (currentDir != null) {
			...
			File serviceEnv = new File(currentDir, "threadly-user-authentication/.env");
			if (serviceEnv.exists() && serviceEnv.isFile()) {
				parseAndSetEnv(serviceEnv);
			}
			File backendServiceEnv = new File(currentDir, "Backend/threadly-user-authentication/.env");
